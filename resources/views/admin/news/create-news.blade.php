...
<div class="row mt site-min-height">
          		<div class="col-lg-6">
                   <div class="form-panel">
                      ...
                      {!!  Form::open(['method'=>'POST','url'=>'admin/news/create','class'=>'form-horizontal style-form','files'=>true])  !!}
                      		  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Name</label>
                              <div class="col-sm-10">
                                  {!!  Form::text('name',null,['class'=>'form-control','placeholder'=>'Input title name...'])  !!}
